...
(function () {
  ...
  const STRINGS = {
    de: {
      ...
      secP5d: 'Der komplette Quellcode ist öffentlich einsehbar — jeder kann nachlesen, was der Dienst tatsächlich tut, statt uns glauben zu müssen. [PLATZHALTER: Link ergänzen, sobald das Repository veröffentlicht ist.]',
      secOpsTitle: 'Betrieb',
    ...
    en: {
      ...
      secP5d: 'The complete source code is publicly viewable — anyone can read exactly what the service does, instead of having to take our word for it. [PLACEHOLDER: add link once the repository is published.]',
